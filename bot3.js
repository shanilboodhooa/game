...
else if(botA.innerText == "X" && botI.innerText == "X" && botE.innerText == ""){
    botE.innerText = "O"
    randomNumber = 0
    console.log(randomNumber)
}
...
if(randomNumber== 5 && botB.innerText == "X" && botE.innerText == "X" && botH.innerText == ""){
    botH.innerText = "O"
    randomNumber = 0
    console.log(randomNumber)
}
if(randomNumber== 2 && botB.innerText == "X" && botH.innerText == "X" && botE.innerText == ""){
    botE.innerText = "O"
    randomNumber = 0
    console.log(randomNumber)
}
